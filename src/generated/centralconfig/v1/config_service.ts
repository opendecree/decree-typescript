...
export function changeTypeFromJSON(object: any): ChangeType {
  switch (object) {
    ...
    case "CHANGE_TYPE_REMOVED":
      return ChangeType.CHANGE_TYPE_REMOVED;
    case 3:
...
export function changeTypeToJSON(object: ChangeType): string {
  switch (object) {
    ...
    case ChangeType.CHANGE_TYPE_REMOVED:
...
function createBaseSetFieldsRequest(): SetFieldsRequest {
  return { tenantId: "", updates: [], description: undefined, idempotencyKey: undefined };
}
...
function createBaseDiffVersionsRequest(): DiffVersionsRequest {
  return { tenantId: "", fromVersion: 0, toVersion: 0 };
}

export const DiffVersionsRequest: MessageFns<DiffVersionsRequest> = {
  encode(message: DiffVersionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tenantId !== "") {
      writer.uint32(10).string(message.tenantId);
    }
    if (message.fromVersion !== 0) {
      writer.uint32(16).int32(message.fromVersion);
    }
    if (message.toVersion !== 0) {
      writer.uint32(24).int32(message.toVersion);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DiffVersionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiffVersionsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.fromVersion = reader.int32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.toVersion = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DiffVersionsRequest {
    return {
      tenantId: isSet(object.tenantId)
        ? globalThis.String(object.tenantId)
        : isSet(object.tenant_id)
      ...
      fromVersion: isSet(object.fromVersion)
        ? globalThis.Number(object.fromVersion)
        : isSet(object.from_version)
        ? globalThis.Number(object.from_version)
        : 0,
  ...
  toJSON(message: DiffVersionsRequest): unknown {
    const obj: any = {};
    if (message.tenantId !== "") {
      obj.tenantId = message.tenantId;
    }
  ...
  create(base?: DeepPartial<DiffVersionsRequest>): DiffVersionsRequest {
    return DiffVersionsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiffVersionsRequest>): DiffVersionsRequest {
    const message = createBaseDiffVersionsRequest();
    message.tenantId = object.tenantId ?? "";
...
function createBaseDiffVersionsResponse(): DiffVersionsResponse {
  return { diffs: [] };
}

export const DiffVersionsResponse: MessageFns<DiffVersionsResponse> = {
  encode(message: DiffVersionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.diffs) {
      FieldDiff.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DiffVersionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiffVersionsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.diffs.push(FieldDiff.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DiffVersionsResponse {
    return {
      diffs: globalThis.Array.isArray(object?.diffs) ? object.diffs.map((e: any) => FieldDiff.fromJSON(e)) : [],
    };
  },

  toJSON(message: DiffVersionsResponse): unknown {
    const obj: any = {};
    if (message.diffs?.length) {
      obj.diffs = message.diffs.map((e) => FieldDiff.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<DiffVersionsResponse>): DiffVersionsResponse {
    return DiffVersionsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiffVersionsResponse>): DiffVersionsResponse {
    const message = createBaseDiffVersionsResponse();
    message.diffs = object.diffs?.map((e) => FieldDiff.fromPartial(e)) || [];
    return message;
  },
};

function createBaseFieldDiff(): FieldDiff {
  return { fieldPath: "", changeType: 0, oldValue: "", newValue: "" };
}

export const FieldDiff: MessageFns<FieldDiff> = {
  encode(message: FieldDiff, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fieldPath !== "") {
      writer.uint32(10).string(message.fieldPath);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FieldDiff {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFieldDiff();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  toJSON(message: FieldDiff): unknown {
    const obj: any = {};
    if (message.fieldPath !== "") {
      obj.fieldPath = message.fieldPath;
    }
  ...
  create(base?: DeepPartial<FieldDiff>): FieldDiff {
    return FieldDiff.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FieldDiff>): FieldDiff {
    const message = createBaseFieldDiff();
    message.fieldPath = object.fieldPath ?? "";
...
function createBaseSubscribeRequest(): SubscribeRequest {
  return { tenantId: "", fieldPaths: [], startVersion: undefined };
}
...
export const SubscribeRequest: MessageFns<SubscribeRequest> = {
  encode(message: SubscribeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.startVersion !== undefined) {
      writer.uint32(24).int32(message.startVersion);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.startVersion = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SubscribeRequest {
    return {
      ...
      fieldPaths: globalThis.Array.isArray(object?.fieldPaths)
        ...
        ? object.field_paths.map((e: any) => globalThis.String(e))
        : [],
      startVersion: isSet(object.startVersion)
        ? globalThis.Number(object.startVersion)
        : isSet(object.start_version)
        ? globalThis.Number(object.start_version)
        : undefined,
    };
  },
  ...
  toJSON(message: SubscribeRequest): unknown {
    ...
    if (message.startVersion !== undefined) {
      obj.startVersion = Math.round(message.startVersion);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SubscribeRequest>): SubscribeRequest {
    ...
    message.tenantId = object.tenantId ?? "";
    message.fieldPaths = object.fieldPaths?.map((e) => e) || [];
    message.startVersion = object.startVersion ?? undefined;
    return message;
  },
};
...
export const ConfigServiceService = {
   ...
   */
  diffVersions: {
    path: "/centralconfig.v1.ConfigService/DiffVersions" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: DiffVersionsRequest): Buffer => Buffer.from(DiffVersionsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DiffVersionsRequest => DiffVersionsRequest.decode(value),
    responseSerialize: (value: DiffVersionsResponse): Buffer =>
      Buffer.from(DiffVersionsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DiffVersionsResponse => DiffVersionsResponse.decode(value),
  },
  /**
...
export interface ConfigServiceServer extends UntypedServiceImplementation {
   ...
   * field path for deterministic output.
   */
  diffVersions: handleUnaryCall<DiffVersionsRequest, DiffVersionsResponse>;
  /**
   * Subscribe opens a server-streaming connection that pushes ConfigChange events
   * whenever the tenant's configuration is modified.
   *
...
export interface ConfigServiceClient extends Client {
  ...
  diffVersions(
    ...
    callback: (error: ServiceError | null, response: DiffVersionsResponse) => void,
  ): ClientUnaryCall;
  diffVersions(
    request: DiffVersionsRequest,
    metadata: Metadata,
