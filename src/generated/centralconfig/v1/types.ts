...
export interface AuditEntry_MetadataEntry {
  key: string;
  value: string;
}
...
export const FieldConstraints: MessageFns<FieldConstraints> = {
  encode(message: FieldConstraints, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.allowedSchemes) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.allowedSchemes.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): FieldConstraints {
    return {
      ...
      maxLength: isSet(object.maxLength)
        ...
        : undefined,
      allowedSchemes: globalThis.Array.isArray(object?.allowedSchemes)
        ? object.allowedSchemes.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.allowed_schemes)
        ? object.allowed_schemes.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: FieldConstraints): unknown {
    ...
    if (message.allowedSchemes?.length) {
      obj.allowedSchemes = message.allowedSchemes;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<FieldConstraints>): FieldConstraints {
    ...
    message.allowedSchemes = object.allowedSchemes?.map((e) => e) || [];
    return message;
  },
};
...
export const AuditEntry: MessageFns<AuditEntry> = {
  encode(message: AuditEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.objectKind !== "") {
      writer.uint32(82).string(message.objectKind);
    }
    if (message.entryHash !== "") {
      writer.uint32(90).string(message.entryHash);
    }
    if (message.previousHash !== "") {
      writer.uint32(98).string(message.previousHash);
    }
    if (message.chainEpoch !== 0) {
      writer.uint32(104).uint64(message.chainEpoch);
    }
    globalThis.Object.entries(message.metadata).forEach(([key, value]: [string, string]) => {
      AuditEntry_MetadataEntry.encode({ key: key as any, value }, writer.uint32(114).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.chainEpoch = longToNumber(reader.uint64());
          continue;
        }
        case 14: {
          if (tag !== 114) {
          ...
          const entry14 = AuditEntry_MetadataEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): AuditEntry {
    return {
      ...
      createdAt: isSet(object.createdAt)
        ...
        ? fromJsonTimestamp(object.created_at)
        : undefined,
      objectKind: isSet(object.objectKind)
        ? globalThis.String(object.objectKind)
        : isSet(object.object_kind)
        ? globalThis.String(object.object_kind)
        : "",
      ...
      previousHash: isSet(object.previousHash)
        ...
        : "",
      chainEpoch: isSet(object.chainEpoch)
        ? globalThis.Number(object.chainEpoch)
        : isSet(object.chain_epoch)
        ? globalThis.Number(object.chain_epoch)
        : 0,
  ...
  toJSON(message: AuditEntry): unknown {
    ...
    if (message.chainEpoch !== 0) {
      obj.chainEpoch = Math.round(message.chainEpoch);
    }
    if (message.metadata) {
  ...
  fromPartial(object: DeepPartial<AuditEntry>): AuditEntry {
    ...
    message.chainEpoch = object.chainEpoch ?? 0;
...
function createBaseAuditEntry_MetadataEntry(): AuditEntry_MetadataEntry {
  return { key: "", value: "" };
}

export const AuditEntry_MetadataEntry: MessageFns<AuditEntry_MetadataEntry> = {
  encode(message: AuditEntry_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuditEntry_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAuditEntry_MetadataEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AuditEntry_MetadataEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: AuditEntry_MetadataEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<AuditEntry_MetadataEntry>): AuditEntry_MetadataEntry {
    return AuditEntry_MetadataEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AuditEntry_MetadataEntry>): AuditEntry_MetadataEntry {
    const message = createBaseAuditEntry_MetadataEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
